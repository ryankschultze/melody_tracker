...
class VADPage extends StatefulWidget {
  ...
  final String title='VAD';

  @override
  __VADPageState createState() => __VADPageState();
}

class __VADPageState extends State<VADPage> {
  ...
  Future<List> _getContour() async{
    ...
    try{
      print(_fileName);
      contour=await platform.invokeMethod("getVAD",<String,dynamic>{
        'name':_file_name,
        'path':_file_path,
      });
    } catch(e){
